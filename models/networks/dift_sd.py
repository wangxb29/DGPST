...
class SDFeaturizer:
    def __init__(self, sd_id='stabilityai/stable-diffusion-2-1', null_prompt='a photo of a portrait'):
        ...
        #null_prompt = [null_prompt, null_prompt]
