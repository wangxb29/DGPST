...
class BaseOptions():
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='DGPST', help='which model to use')
        parser.add_argument('--optimizer', type=str, default='Diff', help='which model to use')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default="D:\\projects\\CelebAMask-HQ\\CelebAMask-HQ\\CelebA-HQ-img")
        parser.add_argument('--dataroot2', type=str, default="D:\\projects\\CelebAMask-HQ\\CelebAMask-HQ\\CelebA-HQ-img")
