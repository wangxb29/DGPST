...
class FaceParser:
    ...
    def parse(self, image: Image):
        ...
        parsing = torch.nn.functional.embedding(parsing, self.dic.unsqueeze(1))
...
if __name__ == '__main__':
    ...
    images = glob.glob('/home/xinbo/datasets/FFHQ_small/FFHQi3/style/*.png')
    savepath = '/home/xinbo/datasets/FFHQ_small/FFHQi3/style_mask/'
